...
KERNEL_NAME="linux-image-5.19.0-43-generic"
KERNEL_VERSION="5.19.0-43"
...
colored_output "Setting kernel ${KERNEL_VERSION}-generic as the default kernel to support AMX host (also guest VMs)..." blue
